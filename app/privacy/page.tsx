    ...
    <main className="shell" style={{ maxWidth: 760 }}>
      ...
      <div className="legal-page">
        ...
        {en ? <PrivacyEnglish /> : <div className="legal-body">
          <p>
            {en ? <>This policy explains how <strong>Weaver</strong> collects, uses, and protects information you provide while using our service. Your privacy matters to us.</> : <>Kebijakan ini menjelaskan bagaimana <strong>Weaver</strong> mengumpulkan, menggunakan, dan melindungi informasi yang Anda berikan saat menggunakan Layanan kami. Privasi Anda penting bagi kami.</>}
          </p>
...
function PrivacyEnglish() {
  return (
    <div className="legal-body">
      <p>This policy explains how <strong>Weaver</strong> collects, uses, and protects information you provide while using our service.</p>
      ...
      <section className="legal-section"><h2>7. Cookies and Local Storage</h2><p>Weaver uses browser storage to maintain authentication state during an active session. We do not use third-party tracking or advertising cookies.</p></section>
